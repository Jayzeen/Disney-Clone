const Franchise = ({}) => {
    return (
        <div className="container">
            ...
            <div className="item">
                <div className="item__border">
                    <img className="item__image" src="https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/2EF24AA0A1E648E6D1A3B26491F516632137ED87AB22969D153316F8BD670FB5/scale?width=640&aspectRatio=1.78&format=png" />
